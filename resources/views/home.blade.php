  ...
  <body>
      ...
      <div class="search-popup-container">
        ...
        <ul class="cat-list">
          <li class="cat-list-item">
            <a href="#" title="Roman">Roman</a>
          </li>
          <li class="cat-list-item">
            <a href="#" title="Science-Fiction">Science-Fiction</a>
          </li>
          <li class="cat-list-item">
            <a href="#" title="Fantasy">Fantasy</a>
          </li>
          <li class="cat-list-item">
            <a href="#" title="CookPoliciering">Policier</a>
          </li>
          <li class="cat-list-item">
    ...
    <li class="cart-dropdown dropdown">
        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">
            ...
            <span class="fs-6 fw-light">({{ count(session('cart', [])) }})</span>
        </a>
        <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
            ...
            @if(count($cart) > 0)
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    <a href="{{ route('cart.index') }}" class="w-100 btn btn-dark mb-1" type="submit">View Cart</a>
                    <a href="{{ route('checkout') }}" class="w-100 btn btn-primary" type="submit">Go to checkout</a>
                </div>
            @else
...
<section id="billboard" class="position-relative d-flex align-items-center py-5 bg-light-gray"
    ...
    <div class="swiper main-swiper">
                    ...
                    <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                        ...
                        <div class="col-md-6 text-center">
                            <div class="image-holder">
                                <img src="{{ $product->image_url }}" class="img-fluid" alt="banner">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="swiper-button-next position-absolute end-0 pe-0 pe-xxl-5 me-0 me-xxl-5">
            <svg class="chevron-forward-circle d-flex justify-content-center align-items-center p-2" width="80" height="80">
                <use xlink:href="#alt-arrow-right-outline"></use>
            </svg>
        </div>
        <div class="swiper-button-prev position-absolute start-0 ps-0 ps-xxl-5 ms-0 ms-xxl-5">
...
<script>
    ...
    var swiper = new Swiper('.main-swiper', {
        ...
        autoplay: {
            delay: 5000, // Défilement automatique des slides
        },
                ...
                @foreach ($products as $product)
                    <div class="swiper-slide">
                        <div class="card position-relative p-4 border rounded-3">
                            <img src="{{ asset($product->image_url) }}" class="img-fluid shadow-sm" alt="{{ $product->name }}">
                            <h6 class="mt-4 mb-0 fw-bold"><a href="#">{{ $product->name }}</a></h6>
                            <p class="my-2 fs-6 text-black-50">{{ $product->description }}</p>
          ...
          <div class="col-md-4">
            <div class="card text-center mb-4 border-0 rounded-3">
              <a href="#">
                ...
                <h6 class=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a href="#"
                    class="text-white">Science-Fiction</a></h6>
              </a>
            </div>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-2">
            <figure class="instagram-item position-relative rounded-3">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                ...
                <img src="{{ asset('images/insta-item1.jpg') }}" alt="instagram" class="img-fluid rounded-3 insta-image">
              </a>
            </figure>
          </div>
          <div class="col-md-2">
            <figure class="instagram-item position-relative rounded-3">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                ...
                <img src="{{ asset('images/insta-item2.jpg') }}" alt="instagram" class="img-fluid rounded-3 insta-image">
              </a>
            </figure>
          </div>
          <div class="col-md-2">
            <figure class="instagram-item position-relative rounded-3">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                ...
                <img src="{{ asset('images/insta-item3.jpg') }}" alt="instagram" class="img-fluid rounded-3 insta-image">
              </a>
            </figure>
          </div>
          <div class="col-md-2">
            <figure class="instagram-item position-relative rounded-3">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                ...
                <img src="{{ asset('images/insta-item4.jpg') }}" alt="instagram" class="img-fluid rounded-3 insta-image">
              </a>
            </figure>
          </div>
          <div class="col-md-2">
            <figure class="instagram-item position-relative rounded-3">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                ...
                <img src="{{ asset('images/insta-item5.jpg') }}" alt="instagram" class="img-fluid rounded-3 insta-image">
              </a>
            </figure>
          </div>
          <div class="col-md-2">
            <figure class="instagram-item position-relative rounded-3">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                ...
                <img src="{{ asset('images/insta-item6.jpg') }}" alt="instagram" class="img-fluid rounded-3 insta-image">
              </a>
            </figure>
          </div>
        </div>
        ...
        <div class="row d-flex flex-wrap justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6 pb-3">
            <div class="footer-menu">
              ...
              <p>
                Nous sommes une entreprise passionnée par la qualité et l'innovation. 
                Découvrez nos produits et services conçus pour répondre à vos besoins.
              </p>
          ...
          <div class="col-lg-3 col-sm-6 pb-3">
            <div class="footer-menu text-capitalize">
              <h5 class="widget-title pb-2">Aide & Informations</h5>
          ...
          <div class="col-lg-3 col-sm-6 pb-3">
            <div class="footer-menu contact-item">
              <h5 class="widget-title text-capitalize pb-2">Contactez-nous</h5>
              <p>
                Vous avez des questions ou des suggestions ? 
                <a href="mailto:contact@monsite.com" class="text-decoration-underline">contact@monsite.com</a>
              </p>
              <p>
                Besoin d'assistance ? Appelez-nous au 
                <a href="tel:+33123456789" class="text-decoration-underline">+33 1 23 45 67 89</a>
              </p>
            </div>
          </div>
        </div>
